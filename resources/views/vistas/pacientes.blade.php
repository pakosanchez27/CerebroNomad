            ...
            @foreach ($pacientes as $paciente)
                <div class="card_paciente card p-5 shadow mb-5 ">
                    ...
                    <div class="d-flex gap-5 justify-content-center ">
                        ...
                        <a href="{{ route('pacientes.edit', $paciente->id) }}" class="btn btn-warning"><svg
                                xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white"
                            ...
                            <form id="deleteForm" action="{{ route('pacientes.destroy', $paciente->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn btn-danger" onclick="return confirm('¿Estás seguro de eliminar al paciente?');">
