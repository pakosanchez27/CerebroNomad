                    ...
                    <div class="col">
                        <div class="card h-100 shadow rounded-3 border-0 bg-light">
                            <div class="card-body text-start">
                                ...
                                <h1 class="display-1"><strong>{{ $totalVentas }}</strong>
                    ...
                    <div class="col">
                        <div class="card h-100 shadow rounded-3 border-0 bg-light">
                            <div class="card-body text-start">
                                ...
                                <h1 class="display-1"><strong>{{ $totalPacientesRegistrados }}</strong>
                    ...
                    <div class="col">
                        <div class="card h-100 shadow rounded-3 border-0 bg-light">
                            <div class="card-body text-start">
                                ...
                                <h1 class="display-1"><strong>{{ $totalPruebasPendientes }}</strong>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{ route('roles.store') }}" method="POST" class="p-3" id="form-rol">
                                        ...
                                        <div class="row">
                                            <div class=" col mb-3">
                                                <label for="recipient-name" class="col-form-label">Primer
                                                    Apellido:</label>
                                            ...
                                            <div class=" col mb-3">
                                                <label for="recipient-name" class="col-form-label">Segundo
                                                    Apellido</label>
