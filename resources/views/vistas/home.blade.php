...
@section('contenido')
                                ...
                                <div class="modal-body">
                                    <form action="{{ route('roles.store') }}" method="POST" class="p-3" id="form-rol">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <!-- Modal -->
                                            <div class="modal fade" id="AgregarColaborador" tabindex="-1"
                                                aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header tabla__header text-white ">
                                                            <h1 class="modal-title fs-3" id="exampleModalLabel">Agrega de
                                                                forma rapida un
                                                                colaborador
                                                            </h1>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="{{ route('roles.store') }}" method="POST"
                                                                ...
                                                                <div class="row">
                                                                    <div class=" col mb-3">
                                                                        <label for="recipient-name"
                                                                            class="col-form-label">Primer Apellido:</label>
                                                                        <input type="text" class="form-control "
                                                                ...
                                                                <div class="modal-footer row">
                                                                    <input type="button"
                                                                        class="col btn btn-danger border-0 w-100 "
                                                                        data-bs-dismiss="modal" value="Cerrar">
                                                                    <input type="submit"
                                                                        class="col btn btn-secondary border-0 w-100  "
                                                                        disabled id="btnSubmit" value="Crear">
                                                                </div>
                                                            </form>
                                                            @if (@session('message'))
                                                                <script>
                                                    ...
                                                    <div class="modal-footer row">
                                                        <input type="button" class="col btn btn-danger border-0 w-100 "
                                                            data-bs-dismiss="modal" value="Cerrar">
                                                        <input type="submit"
                                                            class="col btn btn-secondary border-0 w-100  " disabled
    ...
    <!-- Modal -->
    <div class="modal fade" id="AgregarVendedor" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ route('vendedores.store') }}" method="POST" class="p-4 shadow  rounded-2 " novalidate
                    ...
                    <div class=" row">
                        ...
                        <div class="mb-3 col-12 col-md-6">
                            ...
                            <!-- Modal -->
                            <div class="modal fade" id="AgregarVendedor" tabindex="-1"
                                aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="tabla__header   ">
    ...
    <a href="" class="card card-opcRapida shadow borde-verde" data-bs-toggle="modal"
        ...
        <div class="card-opcRapida__img verde">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="white" class="bi bi-hospital"
                viewBox="0 0 16 16">
                <path
    ...
    <!-- Modal -->
    <div class="modal fade" id="AgregarAseguradora" tabindex="-1" aria-labelledby="modal" aria-hidden="true">
        <div class="modal-dialog modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header tabla__header text-white ">
                ...
                <div class="modal-body">
                    ...
                    <!-- Modal -->
                    <div class="modal
                                fade" id="AgregarAseguradora" tabindex="-1" aria-labelledby="modal" aria-hidden="true">
                                <div class="modal-dialog modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header tabla__header text-white ">
                                            <h1 class="modal-title fs-3" id="exampleModalLabel">Agrega Aseguradora</h1>
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('aseguradoras.store') }}" method="POST"
                                                class="p-4 " novalidate id="miFormulario">
                                                @csrf
                                                <div class="mb-3">
                                                    <label for="nombre" class="form-label">Nombre</label>
    ...
    <div class="modal fade" id="AgregarDoctor" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="tabla__header   ">
                    <p><span class="">Agregar Vendedor </span></p>
                ...
                <form action="{{ route('doctores.store') }}" method="POST" class="p-4 shadow  rounded-2 " novalidate>
                    ...
                    <div class=" row">
                        ...
                        <div class="mb-3 col-12 col-md-6">
                            ...
                            <input type="text" class="form-control" id="apellido_materno" name="apellido_materno"
                                value="{{ old('apellido_materno') }}">
                            <div class="modal fade" id="AgregarDoctor" tabindex="-1"
                                aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="tabla__header   ">
                ...
                <div class="col">
                    <div class="card h-100 shadow rounded-3 border-0 bg-light">
                        <div class="card-body text-start">
                            ...
                            <h1 class="display-1"><strong>0</strong>
                                <p class="card-text text-muted">Total de pacientes registrados</p>
                            </h1>
                ...
                <div class="col">
                    <div class="card h-100 shadow rounded-3 border-0 bg-light">
                        <div class="card-body text-start">
                            ...
                            <h1 class="display-1"><strong>0</strong>
                                <p class="card-text text-muted">Estudios pendientes de completar</p>
                            </h1>
