...
<div class="aseguradora-agregar-contenido p-5 d-flex justify-content-center ">
    ...
    <div class="formulario-agregar w-75 ">
        <div class="tabla__header   ">
            <p><span class="">Editar Vendedor </span></p>
        </div>
        <form action="{{ route('vendedores.update', $vendedor->id) }}" method="POST" class="p-4 shadow  rounded-2 " novalidate>
            @csrf
            @method('PUT')
            <div class="mb-3">
                <label for="nombre" class="form-label">Nombre</label>
                <input type="text" class="form-control" id="nombre" name="nombre" value="{{ $vendedor->name }}">
                @error('nombre')
            ...
            <div class=" row">
                <div class="mb-3 col-12 col-md-6">
                    ...
                    value="{{ $vendedor->apellido_paterno }}">
